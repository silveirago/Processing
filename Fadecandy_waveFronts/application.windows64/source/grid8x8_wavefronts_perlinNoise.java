...
public class grid8x8_wavefronts_perlinNoise extends PApplet {
...
public void draw()
{
  ...
  smoothX += (position.x - smoothX) * 0.1f;
  smoothY += (position.y - smoothY) * 0.1f;

  // At every frame, randomly respawn one ring
  rings[PApplet.parseInt(random(rings.length))].respawn(prevX, prevY, smoothX, smoothY);
...
class Ring
{
  ...
  public void respawn(float x1, float y1, float x2, float y2)
  {
...
class Mover {
  ...
  public void settings() {  size(300, 600, P3D); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "grid8x8_wavefronts_perlinNoise" };
    if (passedArgs != null) {
